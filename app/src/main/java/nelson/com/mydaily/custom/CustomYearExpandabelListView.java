 ...
 * On 2020/3/12 14:24
 */
public class CustomYearExpandabelListView  extends ExpandableListView implements
        AbsListView.OnScrollListener, ExpandableListView.OnGroupClickListener{
    public CustomYearExpandabelListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        registerListener();
    }

    public CustomYearExpandabelListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        registerListener();
    }

    public CustomYearExpandabelListView(Context context) {
        super(context);
        registerListener();
    }
